...
@NamedQueries({ @NamedQuery(name = "AllPerson", query = "select c from Person c"), })

public class Person implements Serializable {
	private static final long serialVersionUID = 23861780991098L;
	...
	public Person(Integer id, String firstName, String lastName, LocalDate birthDate, LocalDate deathDate,
			Integer gender, Integer ownerId, Integer linkId, Integer fatherId, Integer motherId, Integer relatedId) {
		this.id = id;
	...
	public String toString() {
		return "Person [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", birthDate=" + birthDate
				+ ", deathDate=" + deathDate + ", gender=" + gender + ", ownerId=" + ownerId + ", linkId=" + linkId
				+ ", fatherId=" + fatherId + ", motherId=" + motherId + ", relatedId=" + relatedId + "]";
	}
