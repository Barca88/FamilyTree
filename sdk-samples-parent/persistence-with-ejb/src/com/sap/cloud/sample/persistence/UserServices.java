...
import com.sap.cloud.sample.persistence.util.GsonFactory;
...
public class UserServices extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
			...
			if (userId != null) {
				User u =
					personBean.getUserById(Integer.valueOf(userId));
				response.getWriter().println(frontEndGson.toJson(u));
			} else {
				List<User> resultList = personBean.getAllPersons();
